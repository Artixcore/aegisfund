...
export type LlmInvokeRouting = {
  /** Force a specific provider for this request. */
  provider?: LlmProviderId;
  /** Override model id for the resolved provider. */
  model?: string;
  /** Used with `LLM_AGENT_ROUTING` to pick a provider by desk. */
...
export type InvokeParams = {
  ...
  /** Routing: manual override, per-agent rules, or defaults via env. */
  llm?: LlmInvokeRouting;
};
